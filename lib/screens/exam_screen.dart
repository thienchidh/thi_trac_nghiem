...
class _ExamScreenState extends State<ExamScreen> {
  ...
  _ExamScreenState() : _questions = List<Question>() {
    ...
    _subscriptionReachMaxItems = _bloc.loadedAllData.listen(_onReachMaxItem);
...
class ExamScreen1 extends StatefulWidget {
  @override
  _ExamScreen1State createState() => _ExamScreen1State();
}

class _ExamScreen1State extends BaseScreenState<Question> {
  ...
  _ExamScreen1State() : _questions = List<Question>() {
    refresh();
  }
    ...
    return WillPopScope(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (!_isReachMaxItem) {
            loadMore(); // item in last index => load more data
          } else {
            // TODO check no answer, ...
            return SubmitScreen(
              data: data,
